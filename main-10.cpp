...
void StartPhotoshop()
{
    ...
    cout<<"7] Resize \n";
    cout<<"8] Crop \n";
    cout <<"9] Rotate the photo\n";
    cout <<"10] Add a frame\n";
    cout <<"11]Bluring the photo \n";
    cout <<"12]purple\n";
    cout <<"13]merge two photo\n";
    cout<<"14]edge detect\n";
    cout<<"15] Exist \n";
    do
    {
    ...
    } while (choise !=1 && choise !=2 && choise !=3 && choise !=4 && choise !=5 && choise !=6 && choise !=7 && choise !=8 && choise !=9 &&choise!=10&&choise!=11&&choise!=12&&choise!=13 &&choise!=14&&choise!=15);
    if(choise != 13){
...
void MergeImages() {
    cout<<"enter first image name with extension:";
    string image1;
    getline(cin,image1);
    cout<<"enter second image name with extension:";
    string image2;
    getline(cin,image2);
